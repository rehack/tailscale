...
// "ip:port" where ip is a valid IPv4 or IPv6 address corresponding to "udp4" or
// "udp6" respectively. IP must be specified.
//
...
func (s *Server) ListenPacket(network, addr string) (net.PacketConn, error) {
	...
	return s.netstack.ListenPacket(context.Background(), network, ap.String())
}
